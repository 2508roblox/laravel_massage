<div>
    ...
    <head>
        ...
        <title>Báo Giá +50 Mẫu Ghế Massage Toàn Thân Bán Chạy Nhất 2024</title>
        <meta name="description"
            content="Bảng giá 50 ghế massage toàn thân bán chạy nhất, có review chi tiết. Hướng dẫn nên mua ghế massage toàn thân loại nào tốt. Sale 50%">
        ...
        <meta property="og:image"
            content="https://tokuyo.com.vn/uploads/ghe-massage-tokuyo-tich-hop-cong-nghe-hien-dai.jpg?v=1.0.1">
        <meta property="og:image:alt" content="Báo Giá +50 Mẫu Ghế Massage Toàn Thân Bán Chạy Nhất 2024 ">
        <meta property="og:title" content="Báo Giá +50 Mẫu Ghế Massage Toàn Thân Bán Chạy Nhất 2024 ">
        <meta property="og:url" content="https://tokuyo.com.vn/ghe-massage">
        ...
        <link rel="canonical" href="https://tokuyo.com.vn/ghe-massage">
        <link rel="alternate" href="https://tokuyo.com.vn/ghe-massage" hreflang="vi-vn" />
        <link rel="alternate" type="application/rss+xml" title="Tokuyo Feed" href="https://tokuyo.com.vn/rss" />



        <link rel="preload" as="image" data-page="product"
            href="https://tokuyo.com.vn/uploads/cover-cac-dot/mobile.webp?v=4.11">
...
<link rel="dns-prefetch" href="//cdn.autoads.asia"> -->
        ...
        <noscript><img height="1" width="1" style="display:none"
                src="https://www.facebook.com/tr?id=1301459764158352&ev=PageView&noscript=1" /></noscript>
    ...
    <body>
        ...
        <main data-act="act-product">
            @include('livewire.partials.banner')



            <section class="homepage-thong-diep">
                <div class="container">
                    <div class="inner">
                        <div class="item">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-4 text-xl-center"><img
                                        src="/public/client/images/icon/7-ngay.png?v=4.11" alt="Free dùng thử 07 ngày"
                                        width="48" height="48"></div>
                                <div class="col-xl-9 col-8">
                                    <div class="item-title">Free dùng thử 07 ngày</div>
                        ...
                        <div class="item">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-4 text-xl-center"><img
                                        src="/public/client/images/icon/pick-bank.png?v=4.11" alt="Trả góp 0%"
                                        width="48" height="48"></div>
                                <div class="col-xl-9 col-8">
                                    <div class="item-title">Trả góp 0%</div>
                        ...
                        <div class="item">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-4 text-xl-center"><img
                                        src="/public/client/images/icon/bao-hanh.png?v=4.11" alt="Bảo trì trọn đời"
                                        width="48" height="48"></div>
                                <div class="col-xl-9 col-8">
                                    <div class="item-title">Bảo trì trọn đời</div>
                        ...
                        <div class="item">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-4 text-xl-center"><img
                                        src="/public/client/images/icon/van-chuyen-free.png?v=4.11"
                                        alt="Free giao hàng & lắp đặt" width="48" height="48"></div>
                                <div class="col-xl-9 col-8">
                                    <div class="item-title">Free giao hàng & lắp đặt</div>
            ...
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Ghế Massage Toàn Thân</li>
                </ol>
            </div>
            <section class="categorypage-filter">
                <form wire:submit.prevent="applyFilters">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-12">
                                <div class="by-price mb-3">
                                    <div class="checkbox">
                                        <input type="radio" id="range-0" wire:model="selectedPriceRange" value="0-30">
                                        <label for="range-0">Dưới 30 triệu</label>
                                    </div>
                                    <div class="checkbox">
                                        <input type="radio" id="range-1" wire:model="selectedPriceRange" value="30-50">
                                        <label for="range-1">Từ 30 triệu - 50 triệu</label>
                                    </div>
                                    <div class="checkbox">
                                        <input type="radio" id="range-2" wire:model="selectedPriceRange" value="50-100">
                                        <label for="range-2">Từ 50 triệu - 100 triệu</label>
                                    </div>
                                    <div class="checkbox">
                                        <input type="radio" id="range-3" wire:model="selectedPriceRange" value="100-1000">
                                        <label for="range-3">Trên 100 triệu</label>
                                    </div>
                                </div>
                            </div>

                            <div class="col-xl-auto col-lg-3 col-6 mb-3">
                                <select class="form-control form-control-sm" wire:model="selectedBrand" aria-label="Chọn Thương hiệu">
                            ...
                            <div class="col-xl-auto col-lg-3 col-6 mb-3">
                                <select class="form-control form-control-sm" wire:model="selectedCategory" aria-label="Chọn Danh mục">
                            ...
                            <div class="col-xl-auto col-lg-3 col-6 mb-3">
                                <button class="btn btn-sm btn-danger btn-block text-uppercase" type="submit"><i class="bi bi-funnel"></i> Lọc</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <style>
                .product-card .product-card-price .sale {
                    color: #ab1612
                }
            </style>
                    ...
                    <div class="product-list">
                        @foreach ($products as $product)
                            <div class="product-card">
                                <div class="product-card-img-top wrap-ratio aspect-ratio-1x1">
                                    <a href="{{ url('/san-pham/' . $product->category->slug . '/' . $product->slug) }}"
                                        title="{{ $product->name }}"
                                        onclick="dataLayer.push({'event': 'product_click'});">
                                        <img data-src="{{ Storage::url($product->images[0]) }}"
                                            alt="{{ $product->name }}" width="500" height="500"
                                            class="lozad">
                                    </a>
                                    <img src="/public/client/images/icon/japan-flag.png?v=4.11" alt="Japan Flag"
                                        class="japan-flag" width="32" height="32">
                                    <a href="#" data-toggle="modal" data-target="#quickview" data-postid="{{ $product->id }}"
                                        title="Xem nhanh" class="btn-quickview">Xem nhanh</a>
                                        @if($product->promotion)
                                        @php
                                            $discountPercentage = round(($product->promotion / $product->price) * 100);
                                        @endphp
                                        <span class="saleoff">-{{ $discountPercentage }}%</span>
                                    @endif
                                ...
                                <div class="product-card-body">
                                    ...
                                    <div class="product-card-price mb-3">
                                        ...
                                        @if ($product->promotion)
                                            <span class="old">{{ number_format($product->promotion, 0, ',', '.') }}</span>
                                        @endif
                                    </div>
                                    <div class="product-card-gift mb-3">
                                        <span class="icon"><img src="/public/client/images/icon/present.svg?v=4.11"
                                                alt="Gift" width="32" height="32"></span>
        ...
        <span class="small">5</span>
                                        ...
                                        <div class="col-12 col-lg-6 text-lg-right text-center">
                                            ...
                                            <span class="text-dark small">0 Đã bán {{ $product->sold }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="dang-ky-tu-van" id="dang_ky_tu_van" style="content-visibility: auto;">
                <div class="container">
                    ...
                    <form class="_form" onsubmit="return false;">
                        ...
                        <input type="hidden" name="url-complete"
                            value="https://tokuyo.com.vn/lien-he/hoan-thanh">
                        <input type="hidden" name="title" value="Đăng ký tư vấn mua ghế massage">
                        <input type="hidden" name="referrer" value="https://tokuyo.com.vn/ghe-massage">
            ...
            <div class="offcanvas-body">
                <nav class="navbar navbar-expand-xl">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a href="/gioi-thieu" class="nav-link" title="Giới thiệu">Giới
                                thiệu</a></li>
                        <li class="nav-item dropdown"><a href="/ghe-massage" class="nav-link"
                                title="Ghế Massage" data-toggle="dropdown">Ghế Massage</a>
                        ...
                        <li class="nav-item dropdown"><a href="/tin-tuc.html" class="nav-link"
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a href="/tin-tuc/review-dia-diem-mua-ghe-massage"
                                        class="dropdown-item" title="Review địa điểm mua">Review địa điểm mua</a>
                                </li>
                                ...
                                <li class="nav-item"><a href="/tin-tuc/kien-thuc-ghe-massage"
                                        class="dropdown-item" title="Kiến thức ghế massage">Kiến thức ghế
                                        massage</a></li>
                        ...
                        <li class="nav-item"><a href="/nhuong-quyen" class="nav-link"
                                title="Hợp tác kinh doanh">Hợp tác kinh doanh</a></li>
                        <li class="nav-item"><a href="/lien-he.html" class="nav-link" title="Liên hệ">Liên
                                hệ</a></li>
                    </ul>
                </nav>
                <hr>
                <div class="submenu">
                    <ul>
                        ...
                        <li>
                            <a href="https://tokuyo.com.vn/he-thong-cua-hang.html" title="Hệ thống showroom">Hệ
                                thống showroom</a>
                        </li>
                    </ul>
                </div>
