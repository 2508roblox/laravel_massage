                    ...
                    <div class="col-xl-6 col-12">
                        <div id="formRegister">
                            <form onsubmit="return false;">
                                ...
                                <input type="hidden" name="url-request"
                                    value="https://tokuyo.com.vn/lien-he/submit">
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Số điện thoại" type="number"
                                        name="phone">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-button"><button class="btn btn-danger btn-submit"
                                        onclick="contact(this);" type="button" data-parent="#formRegister">Gửi thông
                                        tin</button></div>
                            </form>
                        </div>
                    </div>
